...
VALUES
  (1, 'John', '612-123-1234', 2, '16:00', '', '3342020'),
  (1, 'Jeb', '612-789-7890', 2, '16:00', 'bar', '3342020'),
  (1, 'Jeff', '612-456-4567', 2, '17:00', 'bar', '3342020'),
  (1, 'AJ', '612-743-3196', 2, '17:00', 'bar', '3342020'),
  (1, 'Jane', '612-321-3210', 3, '17:30', '', '3342020'),
  (1, 'Jordan', '612-654-6543', 4, '18:00', 'low top', '3342020'),
  (1, 'Joffrey', '612-987-9876', 2, '18:00', 'booth', '3342020'),
  (1, 'Lauren', '612-852-8520', 1, '18:30', 'bar', '3342020');

INSERT INTO saferes_daily_counts (restaurant_id, res_day, res_week, res_month, res_year, res_weekday)
VALUES 
  (1, '3342020', '482020', '112020', '2020', '7');